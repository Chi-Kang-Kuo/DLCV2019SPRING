...
class VGG(nn.Module):
    ...
    def __init__(self, features, output_size=1274, image_size=448):
        ...
        self.features = features    # vgg16_bn
        self.image_size = image_size

        self.yolo = nn.Sequential(
            #TODO
#             nn.Linear(512*8*8, 4096),  #for image_size = 512
...
def Yolov1_resnet101(pretrained=False, progress=True, **kwargs):
    ...
    """
    yolo = _resnet('resnet101', Bottleneck, [3, 4, 23, 3], False, progress, 
                   **kwargs)
    if pretrained:
